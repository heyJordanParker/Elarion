namespace Elarion.UI {
    ...
    public class UIEdgeMenu : UIElement {
        ...
        // TODO play the open/close animation to both this object and the active screen (aka moving the anchors of this by 0.5 to the side will move the screen as well)
        
        // TODO mirror the active screen's state (close this if the screen closes etc)
