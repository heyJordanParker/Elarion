...
namespace Elarion.Editor.Editors {
    ...
    public class SavedValueEditor : GenericInspector.GenericInspector {
        ...
        protected override void OnEnable() {
            ...
            isSavedVariableEditor = target && !type.IsAbstract && !type.IsGenericType &&
                                    type.GetCustomAttributes(typeof(SavedValueAttribute), true).Length > 0;
